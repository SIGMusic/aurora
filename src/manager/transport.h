...
public:
     ...
     *
     * @return     an identifier for the new connection, or -1 on error
     */
     ...
     *
     * @param[in]  clientid  The client's identifier
     *
     * @return     0 on success, or -1 on error
     */
    virtual int connect(int clientid) = 0;
     ...
     */
    virtual ssize_t recv(int clientid, char* buf, size_t len) = 0;
     ...
     */
    virtual ssize_t send(int clientid, const char* buf, size_t len) = 0;
     ...
     * @return     0 on success, or -1 on error
     */
    virtual int close(int clientid) = 0;
};
